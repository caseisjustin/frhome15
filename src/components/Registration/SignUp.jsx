...
export default function RegisterForm() {
    ...
    return (
        <>
            <div
                className="bg-blue-300 text-white active:bg-pink-600 font-bold uppercase text-sm px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150 cursor-pointer"
                type="button"
                            ...
                            <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                                <div className="block max-w-sm rounded-lg bg-white p-6 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
                                    ...
                                    <section className="bg-gray-50 dark:bg-gray-900">
                                        <h2 onClick={() => setShowModal(false)} className="absolute right-0 text-white text-[50px] cursor-pointer">X</h2>
